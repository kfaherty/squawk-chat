...
class Authorize extends React.Component<IAuthorizeProps, IAuthorizeState> {
  ...
  handleConnectClick(option: any) {
    // TODO: fix this.
    if (option.obj) {
      createSocket(option.obj).catch((error) => {
        console.log(error);
        // route to login.
  ...
  render() {
    ...
    return (
      <div
        className={"authorize-contain " + (this.props.visible ? "" : "visible")}
      >
        ...
        <div className="authorize-modal">
          ...
          <div className={"login " + (this.state.showLogin ? "active" : "")}>
            <div
              className={
                "login-input " + (this.state.usernamehaserror ? "error" : "")
              }
            >
              <StandardInput
                inputName="Username"
            ...
            <div
              className={
                "login-input " + (this.state.passwordhaserror ? "error" : "")
              }
            >
              <StandardInput
                inputName="Password"
          ...
          <div
            className={
              "character-select " + (this.state.showLogin ? "" : "active")
            }
          >
        ...
        <div
          className={"error-wrap " + (this.state.showError ? "visible" : "")}
        >
          {this.state.error}
        </div>
      </div>
